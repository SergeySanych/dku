# Generated by Django 4.1.4 on 2023-03-01 10:01
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('news', '0018_alter_internalpage_related_pages'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='news.formpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
